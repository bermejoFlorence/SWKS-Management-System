...
/* Past days: grey background + grey date number (month & time views) */
.calendar-card .fc .fc-daygrid-day.fc-day-past,
.calendar-card .fc .fc-timegrid-col.fc-day-past {
  background-color: #f2f4f7; /* neutral light */
}
.calendar-card .fc-day-past .fc-daygrid-day-number {
  color: #6b7280; /* gray-500 */
}
/* Optional: show "disabled" cursor on day header area */
...
/* Keep event chips readable on past days */
.calendar-card .fc-day-past .fc-event,
.calendar-card .fc-day-past .fc-event .fc-event-main {
  filter: none;
  opacity: 1;
}
...
#dayEventsList .list-group-item .text-muted {
  color: rgba(255,255,255,.75) !important;
}
#dayEventsList .list-group-item:hover,
#dayEventsList .list-group-item:focus {
  background-color: #111827;   /* slate-900 */
  color: #fff;
}

/* Buttons inside the list (right side) */
#dayEventsList .btn-outline-primary,
#dayEventsList .btn-outline-danger {
  color: #fff;
  border-color: #fff;
}
#dayEventsList .btn-outline-primary:hover {
  background-color: #0d6efd; border-color: #0d6efd;
}
#dayEventsList .btn-outline-danger:hover {
  background-color: #dc3545; border-color: #dc3545;
}

/* ===== White text ONLY for month/week/day tiles (not list view) ===== */
...
.calendar-card .fc .fc-daygrid-event .fc-event-title {
  color: #fff !important;
}
...
/* ===== List view (listWeek/listDay): dark text + readable hover ===== */
.calendar-card .fc .fc-list-event td {
  background: #ffffff;
  color: #111827;              /* gray-900 */
  border-color: #e5e7eb;       /* gray-200 */
}
.calendar-card .fc .fc-list-event:hover td,
.calendar-card .fc .fc-list-event:focus td {
  background: #f3f4f6;         /* gray-100 */
  color: #111827;
}

/* dot color sa list view para match sa brand */
.calendar-card .fc .fc-list-event-dot {
  border-color: #198754;
  background-color: #198754;
}

/* header rows ng list view */
.calendar-card .fc .fc-list-day-cushion {
  background: #eef2f7;         /* subtle header bg */
  color: #111827;
  font-weight: 700;
}
.calendar-card .fc .fc-list-day-text,
.calendar-card .fc .fc-list-day-side-text {
  color: #111827;
}
