...
// 1) Start output buffering (para sabay-sabay mag-flush ang output)
ob_start();
...
// ✅ BAGO — member_details (tamang org ng member)
$stmt = $conn->prepare("
        ...
        <div id="forumPostsContainer">
          ...
          <div class="col-md-7 col-12 mt-2 mt-md-0 d-flex justify-content-md-end">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <form id="forumPostForm" action="forum_post_action.php" method="post" enctype="multipart/form-data" class="d-flex flex-column flex-md-row align-items-center gap-2" autocomplete="off">
            ...
            <?php foreach ($posts as $row): ?>
                ...
                $post_id = $row['post_id'];
                $commentCount = 0;
                    if ($cStmt = $conn->prepare("SELECT COUNT(*) AS cnt FROM forum_comment WHERE post_id = ?")) {
...
?>
<?php
echo "<!-- member_pic raw value: " . htmlspecialchars($row['member_pic']) . " -->";
?>
...
<?php
// 4) Huling hakbang: i-flush ang buong buffer nang minsanan
ob_end_flush();