    ...
    <div class="ms-auto d-flex align-items-center" style="gap:16px;">
        ...
        <div class="dropdown">
            <?php if ($profilePic): ?>
                ...
                <img src="/swks/uploads/<?= htmlspecialchars($profilePic) ?>" alt="Profile" class="rounded-circle" width="32" height="32" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="object-fit:cover;cursor:pointer;">
            <?php else: ?>
                <!-- Fallback to icon -->
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow profile-dropdown" aria-labelledby="profileDropdown" style="min-width: 260px;">
                <li class="px-3 py-2 mb-1 user-info-area">
                    ...
                    <div class="text-success fw-semibold mb-1" style="font-size:1.07rem;">
                      <?= htmlspecialchars($orgName) ?> Member
                    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center pt-0">
        <div class="profile-icon d-inline-block rounded-circle p-1 shadow" style="margin-bottom:10px;">
          <?php if ($profilePic): ?>
             <img src="/swks/uploads/<?= htmlspecialchars($profilePic) ?>"
        ...
        <div class="modal-body pb-2">
          ...
          <div class="text-center mb-3">
            <label for="profilePicInput" class="d-block mb-2" style="cursor:pointer;">
              <?php if ($profilePic): ?>
                 <img id="profilePicPreview" src="/swks/uploads/<?= htmlspecialchars($profilePic) ?>"
